...
function onUpdate()
	...
	doTweenY('Cinematics1', 'UpperBar', -60, 0.5, 'Linear')
	doTweenY('Cinematics2', 'LowerBar', 650, 0.5, 'Linear')
	noteTweenY('NOTEMOVE1', 0, 70, 0.5, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 70, 0.5, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 70, 0.5, 'Linear')
	...
	doTweenAlpha('AlphaTween9', 'BotplayTxt', 0, 0.25)
	...
	doTweenAlpha('AlphaTween8', 'TimeTxt', 0, 0.25)
	doTweenAlpha('AlphaTween9', 'BotplayTxt', 0, 0.25)
	noteTweenY('NOTEMOVE1', 0, 510, 0.5, 'Linear')	
	noteTweenY('NOTEMOVE2', 1, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE3', 2, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE4', 3, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE5', 4, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE6', 5, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE7', 6, 510, 0.5, 'Linear')
	noteTweenY('NOTEMOVE8', 7, 510, 0.5, 'Linear')
	end
	...
	doTweenAlpha('AlphaTween9', 'BotplayTxt', 1, 0.25)
...
function onEvent(name,value1,value2)
	if name == 'Cinematics_Little' then
